...
(function ($) {
  ...
  /**
   * Smooth scroll to savings section when accordion is opened
   */
  function scrollToSavingsSection() {
    var $section = $(".zg-product-savings-section");
    if ($section.length) {
      $("html, body").animate(
        {
  ...
  /**
   * Add loading state to accordion
   */
  function addLoadingState() {
    $(".zg-accordion-header").addClass("loading");
    $(".zg-accordion-icon").html('<span class="loading-spinner">⟳</span>');
  }

  /**
   * Remove loading state from accordion
   */
  ...
  window.ZGSavingsAccordion = {
    ...
    scrollToSavingsSection: scrollToSavingsSection,
  };
})(jQuery);
