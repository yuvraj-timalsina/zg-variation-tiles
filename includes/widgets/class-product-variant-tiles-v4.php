...
class ProductVariantTilesV4 extends  Widget_Base
{
    ...
    $version = '1.0.1.' . time();
        ...
        wp_register_script('vt-stock-messages', PROTILES_URL . 'assets/js/stock-messages.js', array('jquery'), $version, true);
    ...
    public function get_style_depends()
    {
        ...
        $deps = ['pro-tiles-elementor', 'zg-savings-accordion', 'vt-stock-messages'];
    ...
    private function render_form_button($product)
    {
        ...
        // Include stock messages template
        include PROTILES_DIR . 'includes/templates/stock-messages.php';
