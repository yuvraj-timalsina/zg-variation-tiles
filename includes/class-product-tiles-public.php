...
class Product_Tiles_Public
{
	...
	{
		if ( ! wp_style_is( 'woo-variation-swatches-frontend', 'registered' ) ) {
		        wp_register_style('woo-variation-swatches-frontend', PROTILES_URL . 'assets/css/woo-variation-swatches-frontend.css', array(), '1.0.0.' . time());
		}
	}
	...
	public function maybe_dequeue_fallback_style() {
		if ( function_exists('is_product') && is_product() ) {
			if ( wp_style_is( 'commercekit-attribute-swatches-css', 'enqueued' ) && wp_style_is( 'woo-variation-swatches-frontend', 'enqueued' ) ) {
